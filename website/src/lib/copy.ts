export const copy = {
  ...
  stats: {
    ...
    dataSourceBody:
      "Stats are calculated locally from active notes and topics returned by the existing sync endpoint. No extra backend endpoint is required for these counts yet.",
  },
  skills: {
    add: "Add",
    added: "Added",
